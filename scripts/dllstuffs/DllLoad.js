const WindowsTools = DllLoad(__dirname+"/WindowsTools.dll");
...
while(!GetKey(VK_ESCAPE)) {
    ...
    if(GetKey('T'.charAt(0))) {
        ...
        print(shit.x, shit.y);
        WindowsTools("newWord", 3, [200.5, 200.5, "oops bruh there is some garbage shits happening hee"], [VAR_FLOAT, VAR_FLOAT, VAR_CSTRING], RETURN_NUMBER, false); //newWord in WindowsTools take float, float, const char* (and returns void)
