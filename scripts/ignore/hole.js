...
const FS = `#version 300 es
    ...
    void main() {
        ...
        if(distance(vMouse.xy, uv) < .1) {
            final = texture(iChannel1, uv).zyx);
        }
...
window = CreateWindow(WS_EX_LAYERED | WS_EX_TOPMOST | WS_EX_TRANSPARENT, wc, "hole.js", WS_POPUP | WS_VISIBLE, 0, 0, screenWidth, screenHeight, NULL, NULL, hInstance);