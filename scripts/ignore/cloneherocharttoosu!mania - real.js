...
//let filename = `${__dirname}/test3.chart`; //`C:/Users/megal/Documents/Clone Hero/Songs/The Boneyard - The Olympian/notes.chart`;//`${__dirname}/notes.chart`;
let filename = `C:/Users/megal/Documents/Clone Hero/Songs/The Boneyard - The Olympian/notes.chart`;
...
function getTempoAt(time) {
    ...
    print(`retTempo: ${retTempo}, curTempo: ${curTempo}`);
            ...
            if(note.args.at(-1) != 0) {
                ...
                if(changes.length > 0) {
                    ...
                    for(let i = 1; i < changes.length; i++) {
                        ...
                        print(start-lastStart, lastTempo);
