let d2d, brush, gradient; //bmpBrush, temp;
let i;
...
function windowProc(hwnd, msg, wp, lp) {
    if(msg == WM_CREATE) {
        ...
        gradient = d2d.CreateLinearGradientBrush(0,0,256,256,d2d.CreateGradientStopCollection([0.0, 1.0, 0.0, 0.0], [0.5, 0.0, 1.0, 0.0], [1.0, 0.0, 0.0, 1.0]));
        ...
        gradient.SetTransform(d2d.Matrix3x2.Rotation(i, 128, 128));
